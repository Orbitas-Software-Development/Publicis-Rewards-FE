...
const handleSort = (property: typeof sortBy) => {
  ...
  const currentItems = getSortedEmployees(filteredEmployees).slice(startIndex, startIndex + rowsPerPage);
           ...
           <Table stickyHeader sx={{ height: isShortResult ? 'auto' : '100%' }}>
            <TableHead>
                ...
                <TableCell sx={{ backgroundColor: theme.palette.publicisGrey.main }}>                
                    <Typography variant="subtitle2" fontSize={16}>#</Typography>                
                </TableCell>
              <TableCell sortDirection={sortBy === 'employeeNumber' ? sortOrder : false} sx={{ backgroundColor: theme.palette.publicisGrey.main }}>
                ...
                >
                    <Typography variant="subtitle2" fontWeight={sortBy === 'fullName' ? 'bold' : '500'} fontSize={16}>
                    Nombre
                    </Typography>
                </TableSortLabel>
                </TableCell>
            ...
            <TableBody>
                ...
                currentItems.map((emp, index) => {
                    ...
                    >
                        <TableCell><Typography variant='body1' fontSize={16} fontWeight={'500'}>{startIndex + index + 1}</Typography></TableCell>
                        <TableCell><Typography variant='body1' fontSize={16} >{emp.employeeNumber}</Typography></TableCell>
